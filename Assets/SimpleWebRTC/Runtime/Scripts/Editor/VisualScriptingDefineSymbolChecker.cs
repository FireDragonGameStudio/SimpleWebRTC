...
namespace SimpleWebRTC {
    ...
    public static class VisualScriptingDefineSymbolChecker {
        ...
        private static bool HasVisualScripting() {
            //ListRequest _listRequest = Client.List(true); // true = include dependencies
        ...
        //                    Debug.Log("Visual Scripting is installed.");
        //                    return true;
        //                }
        //            }

        //            Debug.LogWarning("Visual Scripting is NOT installed.");
